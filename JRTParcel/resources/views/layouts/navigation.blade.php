<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 border-solid border-solid">
    <!-- Primary Navigation Menu -->
    <div class="max-w-full mx-auto sm:px-6 lg:px-8 border-solid border-solid">
